...
[![Skills](https://skillicons.dev/icons?i=py,js,ts,react,nextjs,tailwind,nodejs,fastapi,supabase,postgres,docker,git,vscode,vercel,figma,tensorflow,pytorch,sklearn,java,php,vue,vite,threejs,unity,unreal,processing,pycharm,androidstudio,powershell,html,lua,matlab)](https://skillicons.dev)
...
- Building web, desktop & mobile apps
- Open to work
